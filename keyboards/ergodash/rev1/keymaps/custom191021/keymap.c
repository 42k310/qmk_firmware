...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_GRV,  KC_LALT, KC_LGUI, KC_LCTL,         KC_LOWR,    KC_SPC , XXXXXXX,      XXXXXXX, KC_ENT , RAISE,            KC_LGUI, KC_LEFT, KC_RGHT,   RAISE  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_GRV, KC_LALT, KC_LGUI, KC_LCTL,            KC_LOWR, KC_SPC, XXXXXXX,       XXXXXXX, KC_BTN1, KC_BTN2,          KC_HOME, KC_PGDN, KC_PGUP, KC_END  \
  ),
