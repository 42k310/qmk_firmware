...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
     * |   `  |  GUI |  ALt | EISU |||||||| Lower| Space|||||||||||||||||||||| Enter| Raise|||||||| GUI  |  [   |  ]   | Right|
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
    [_QWERTY] = LAYOUT(
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,  KC_T,   KC_MINS,          KC_EQL,  KC_Y,   KC_U,  KC_I,    KC_O,    KC_P, KC_BSLS,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,  KC_G,   KC_LBRC,          KC_BSPC, KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,          ,                 , KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_GRV,  KC_LALT, KC_LGUI, KC_LCTL, LOWER, KC_SPC, XXXXXXX,          XXXXXXX, KC_ENT, RAISE, KC_LGUI, KC_LBRC, KC_RBRC, RAISE
        ),
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_DOT,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,    KC_EQL,            KC_BSPC, XXXXXXX, XXXXXXX, KC_UP,   KC_LBRC,  KC_RBRC, KC_DQT,
        KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,   KC_0,    XXXXXXX,           XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, KC_QUES, KC_RSFT,
